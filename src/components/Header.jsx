...
import { Star, LogOut, User, X } from 'lucide-react'
import { roleLabels } from '../auth.js'
...
export default function Header({ currentUser, onLogout }) {
  ...
  const profileData = currentUser ? {
    ...
    lastLogin: new Date(currentUser.lastLogin).toLocaleString('en-IN'),
  } : null
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="font-display text-sm text-pnb-crimson font-semibold">
                Welcome, {currentUser?.username || 'operator'}..!
              </span>
            </button>
