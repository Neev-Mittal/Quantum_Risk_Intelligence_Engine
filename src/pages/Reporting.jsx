        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className={`w-full bg-gradient-to-r from-pnb-gold to-pnb-amber text-white font-display
        ...
        <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-4">
          ...
          <div className="flex items-center gap-6 flex-wrap">
            ...
            <button
              ...
              className={`ml-auto bg-gradient-to-r from-pnb-gold to-pnb-amber text-white font-display
